...
// 	}
// 	if !util.ContainsInSlice([]reflect.Kind{reflect.Int, reflect.Int64}, reflect.TypeOf(d[0]).Kind()) {
...
// 	}
// 	val := time.Duration(reflect.ValueOf(d[0]).Int())
...
// 	if m%time.Millisecond != 0 {
// 		d = &Duration{m / time.Millisecond, TimeUnit[0]}
// 	} else if m%time.Second != 0 {
